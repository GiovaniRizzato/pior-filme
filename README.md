...
Welcome to the Raspberry Award Tracking System project repository! This project consists of an Angular solution developed to visualize *Raspberry Award* statistics, according to the specification presented in [Documentation (PT-br)](documentacao/Especificação.pdf).
...
## Using the solution in a production environment :rocket:
